...
<html>
    ...
    <head>
        <link rel='stylesheet' href='style/campionato.css'>
        <script src='script/campionato.js' defer></script>
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta charset="utf-8">

        <title>motoGP - campionato</title>
    ...
    <body>
        ...
        <div class="prefInfo">
            <h1>Ecco i Gran Premi del 2024</h1>
        </div>  

        <section class="circuit-section">
            <div class="circuit">
                <span class="date">28 giu -> 30 giu</span>
                <span class="name">Motul TT Assen</span>
                <img class="image" src="https://resources.motogp.pulselive.com/photo-resources/2023/11/23/5483c54e-0f29-4d71-988e-295721504f2e/NED.jpg?height=125&width=412" >
                <img class="preferiti" src="images/notstar.png"/>
            </div>
            <div class="circuit">
                <span class="date">05 lug -> 07 lug</span>
                <span class="name">Gran Prix Deutschland</span>
                <img class="image" src="https://resources.motogp.pulselive.com/photo-resources/2023/11/23/c7920a23-ce6e-45d4-a3ea-9efac8d55e4e/GER.jpg?height=125&width=412" >
                <img class="preferiti" src="images/notstar.png"/>
            </div>
            <div class="circuit">
                <span class="date">02 ago -> 4 ago</span>
                <span class="name">Monster British Gran Prix</span>
                <img class="image" src="https://resources.motogp.pulselive.com/photo-resources/2023/11/23/87a831a7-6975-46b4-a2b8-a1c924970372/AUT.jpg?height=125&width=412" >
                <img class="preferiti" src="images/notstar.png"/>
            </div>
            <div class="circuit">
                <span class="date">16 ago -> 18 ago</span>
                <span class="name">Gran Prix von Osterreich</span>
                <img class="image" src="https://resources.motogp.pulselive.com/photo-resources/2023/11/23/66b9121c-ce58-469f-b599-55cbe424a3b4/QAT.jpg?height=125&width=412" >
                <img class="preferiti" src="images/notstar.png"/>
            </div>
            <div class="circuit">
                <span class="date">30 ago -> 01 set</span>
                <span class="name">Gran Premio GoPro de Aragon</span>
                <img class="image" src="https://resources.motogp.pulselive.com/photo-resources/2023/11/23/04145035-6df9-4c12-9f9b-4081f5ab8df0/ARA.jpg?height=125&width=412" >
                <img class="preferiti" src="images/notstar.png"/>
            </div>
            <div class="circuit">
                <span class="date">06 set -> 8 set</span>
                <span class="name">Gran Premio RedBull San Marino</span>
                <img class="image" src="https://resources.motogp.pulselive.com/photo-resources/2023/11/25/f771ca0b-45e8-4389-8492-7597e6e73ff9/rsm.jpg?height=125&width=412" >
                <img class="preferiti" src="images/notstar.png"/>
            </div>
            <div class="circuit">
                <span class="date">20 set -> 22 set</span>
                <span class="name">Gran Prix of Kazakhstan</span>
                <img class="image" src="https://resources.motogp.pulselive.com/photo-resources/2023/11/23/02187b42-3efc-47a1-bd5d-0d0f366c9c6c/THAI.jpg?height=125&width=412" >
                <img class="preferiti" src="images/notstar.png"/>
            </div>
            <div class="circuit">
                <span class="date">27 set -> 29 set</span>
                <span class="name">Gran Prix of Indonesia</span>
                <img class="image" src="https://resources.motogp.pulselive.com/photo-resources/2023/11/23/d500a421-39ac-4fa0-850d-059700e3aba9/INA.jpg?height=125&width=412" >
                <img class="preferiti" src="images/notstar.png"/>
            </div>
        </section>
