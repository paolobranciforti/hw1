...
<html>
    ...
    <head>
        <link rel='stylesheet' href='style/meteo.css'>
        <script src='script/meteo.js' defer></script>
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta charset="utf-8">
        <title>motoGP - meteo</title>
    </head>
    ...
    <body>
        ...
        <div class="meteo">
            <button class="btn-circuito-meteo" id="btn_portogallo" lat="37.23176319212685" lon="-8.630198609731101">Portogallo</button>
            <button class="btn-circuito-meteo" id="btn_america" lat="30.132884596630063" lon="-97.64038031620804">America</button>
            <button class="btn-circuito-meteo" id="btn_spagna" lat="36.710584191165765" lon="-6.032904690778857">Spagna</button>
