...
<html>
    <?php 
        ...
        // Esegui la query per recuperare i circuiti preferiti dell'utente
        $query_preferiti = "SELECT circuito FROM gare WHERE id = $userid";
        $res_preferiti = mysqli_query($conn, $query_preferiti);

        // Crea un array per memorizzare i nomi dei circuiti preferiti
        $circuiti_preferiti = array();

        // Popola l'array con i nomi dei circuiti preferiti
        while ($row = mysqli_fetch_assoc($res_preferiti)) {
            $circuiti_preferiti[] = $row['circuito'];
        }
    ?>
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>motoGP - <?php echo $userinfo['name']." ".$userinfo['surname'] ?></title>
    </head>
    ...
    <body>
        ...
        <div class="prefInfo">
            <h1>I tuoi circuiti preferiti</h1>
        </div>  
        ...
        <div class="race">
            ...
            <div class="circuit-list">
                <?php
                    if (!empty($circuiti_preferiti)) {
                        foreach ($circuiti_preferiti as $circuito) {
                            echo "<div class='circuit-item'>" . ($circuito) . "</div>";
                        }
                    } else {
                        echo "<p>Non hai ancora aggiunto nessun circuito ai preferiti.</p>";
                    }
                ?>
            </div>
        </div>
        ...
        <div class="prefInfo">
            <h1>I tuoi musicgp preferiti</h1>
        </div>  
