<html>
    ...
    <body>
        <header>
            <nav>
                <div class="navbar">
                    ...
                    <a class="navbar-element" href='signup.php'>ISCRIVITI</a>
                    <div id="separator"></div>
                    <a class="navbar-element" href='login.php' class='button'>ACCEDI</a>
                </div>
                <div id="menu">
                    <div></div>
                    <div></div>
        ...
        <article class="main-news">
            <header class="articolo-principale">
                <div class="overlay-main-news">
                    <h1> In Portogallo è il giorno delle qualifiche e della Tissot Sprint!  </h1>
                </div>
            </header>
        </article>
        ...
        <div class="slider-container">
            <div class="slider-element">
                <a href="https://www.motogp.com/it/calendar/2024/event/portugal/bccf48d6-3242-4827-95df-54a2048521c3">Programma & Lista degli iscritti</a>
            </div>
            <div class="slider-element">
                <a href="https://www.motogp.com/it/world-standing/2024/motogp/championship-standings">Classifiche</a> 
            </div>
            <div class="slider-element">
                <a href="https://www.motogp.com/it/videopass/archive/season-2024/portugal">Guarda i video</a>
            </div>
            <div class="slider-element">
                <a href="https://www.motogp.com/it/records#grande-premio-de-portugal">Record del circuito</a>
            </div>
        </div>

        <div id="pubblicita">
            <img src="https://adsx.motogp.com/2024_Milestone/PreOrder/1472x100.jpg">
        </div>
